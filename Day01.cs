...
namespace Advent_of_Code
{
    public class Day01
    {
        ...
        public static int? RepeatedFrequencyProblem()
        {
            ...
            {
                var (int1, int2) = Iterate(seenValues, currentValue);
                foundDuplicate = int1;
                currentValue = int2;
            }
        ...
        private static (int?, int) Iterate(List<int> seenValues, int currentValue)
        {
            int? foundDuplicate = null;
            foreach (var value in puzzleInput)
            {
                ...
                {
                    foundDuplicate = currentValue;
                    break;
                }
                seenValues.Add(currentValue);
            }

            return (foundDuplicate, currentValue);
        }
